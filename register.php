...
<body>
    ...
    <form action="register_db.php" method="post">
        ...
        <div class="form-group">
            <h3>Email</h3>
            <input type="email" name="email" class="form__input" pattern=".{6,}" required>
            <span class="icon"></span>
        </div>
        <div class="form-group">
            <h3>Password</h3>
            <input type="password" name="password_1" class="form__input" pattern=".{6,}" required>
            <span class="icon"></span>
        </div>
        <div class="form-group">
            <h3>Confirm Password</h3>
            <input type="password" name="password_2" class="form__input" pattern=".{6,}" required>
            <span class="icon"></span>
        </div>
        <div class="form-group">
        <button type="submit" name="reg_user" class="my-2 btn btn-success">ตกลง</button>
        </div>
        <a href="/login.php" class="my-2 btn btn-warning">ล็อกอิน</a></form>
    </form>
