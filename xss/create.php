...
<a href="index.php" class="btn btn-outline-dark">กลับหน้าแรก</a>
   <div class="container mt-5">
        <form method="POST">
            <input type="text" placeholder="หัวข้อโพสต์" class="form-control my-3 bg-dark text-white text-center" name="title">
            <textarea name="content" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post">โพสต์</button>
        </form>
   </div>
