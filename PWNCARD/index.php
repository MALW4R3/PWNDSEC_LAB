...
<body>
    ...
    <div class="card wow fadeInUp">
		<div class="card-body">
        <h1>⚠ คำเตือน ทางเราไม่ได้มีเจตนาที่ จะ ใช้ในเชิงพาณิชย์แต่อย่างใดทางเรา แค่เช็ค บัตรเครดิตของท่านและเทียบกับเว็บอื่นๆ ⚠</h1>
    </div>
        <div class="form-group">
        <a href="checkcard.php" button type="submit" name="login_user" class="my-2 btn btn-success">ตกลง</button></a>
        </div>
        </div>
        </div>
        </div>
